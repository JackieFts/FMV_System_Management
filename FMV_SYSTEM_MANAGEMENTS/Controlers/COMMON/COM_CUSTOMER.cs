...
namespace FMV_SYSTEM_MANAGEMENT.Controlers
{
    public class COM_CUSTOMER
    {
        ...
        public async Task Add(T_COM_CUSTOMER _cus)
        {
            ...
            {
                Program.log.LogMsg(Logger.LogLevel.FATAL, "Add Customer Error : {0}", ex.Message);
                Program.log.LogMsg(Logger.LogLevel.FATAL, "Add Customer Error : {0}", ex.StackTrace);
            }
        }
        ...
        public async Task Update(T_COM_CUSTOMER _cus)
        {
            ...
            {
                Program.log.LogMsg(Logger.LogLevel.FATAL, "Update Customer Error : {0}", ex.Message);
                Program.log.LogMsg(Logger.LogLevel.FATAL, "Update Customer Error : {0}", ex.StackTrace);
            }
        }
        ...
        public async Task Delete(string id)
        {
            ...
            {
                Program.log.LogMsg(Logger.LogLevel.FATAL, "Delete Customer Error : {0}", ex.Message);
                Program.log.LogMsg(Logger.LogLevel.FATAL, "Delete Customer Error : {0}", ex.StackTrace);
            }
        }
    }
}
