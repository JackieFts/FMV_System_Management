    ...
    public partial class fFunc_Import : DevExpress.XtraEditors.XtraForm
    {
        ...
        private async void btnSave_Click(object sender, EventArgs e)
        {
            if (gvList.RowCount > 0 &&
                XtraMessageBox.Show("Are you sure to Save this table data to Server?", "INFORM", MessageBoxButtons.OKCancel, MessageBoxIcon.Information)
                == DialogResult.OK)
            {
                ...
                {
                    XtraMessageBox.Show("You need to contact FMV-Tai if you want to save this sheet");
                    return;
                }
                this.Close();
            }
