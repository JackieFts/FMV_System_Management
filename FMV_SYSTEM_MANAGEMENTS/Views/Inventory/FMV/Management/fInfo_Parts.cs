...
namespace FMV_SYSTEM_MANAGEMENTS.Views
{
    public partial class fInfo_Parts : DevExpress.XtraEditors.XtraForm
    {
        ...
        private async void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            {
                XtraMessageBox.Show("Pls click into row data first and then click Update !");
            }
        }
        ...
        private async void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            {
                XtraMessageBox.Show("Pls click into row data first and then click Delete !");
            }
        }
        ...
        private void gcPartOut_DragDrop(object sender, DragEventArgs e)
        {
            ...
            {
                XtraMessageBox.Show("This part does not avaliable", "WARNING", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
